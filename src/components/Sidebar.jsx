...
const Sidebar = ({ isCollapsed }) => {
  ...
  return (
    <div ref={sidebarRef} className="h-full w-[10vw] sm:w-full overflow-visible bg-white shadow-lg transition-all duration-300 flex flex-col relative">
      {/* Logo */}
      <div className="flex justify-center items-center bg-white pt-3 sm:p-5">
        <Link to="/dashboard">
          <img src={logo} alt="logo" className="h-auto w-auto object-contain sm:min-w-[49px]" />
        </Link>
      </div>
