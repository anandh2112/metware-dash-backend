...
const EnergySources = () => {
  ...
  return (
    <div className="bg-white xl:h-[100%] p-4 sm:p-7 rounded-lg shadow-md flex flex-col space-y-7">
      <div className="flex justify-between items-center">
        <h2 className="text-lg sm:text-xl font-semibold">Facility Overview</h2>
        <div className="relative">
          <input
            type="date"
            value={localSelectedDate} // Use local state
            onChange={handleLocalDateChange} // Update local state
            className="px-1 sm:px-2 py-1 border border-gray-300 rounded-md text-sm"
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 xl justify-start items-start">
          <div>
            <div className="space-y-3 xl:space-y-5 lg:space-y-4 md:space-y-4">
              <div className="border border-red-500 p-2 sm:p-3 rounded-lg shadow">
              ...
              <div className="border border-green-500 p-2 sm:p-3 rounded-lg shadow">
              ...
              <div className="border border-blue-500 p-2 sm:p-3 rounded-lg shadow">
          ...
          <div className="flex justify-center items-center sm:mt-6 sm:pt-8">
