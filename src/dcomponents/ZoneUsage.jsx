...
const ZoneUsage = () => {
  ...
  return (
    <>
      <div className="relative bg-white p-4 sm:p-7 rounded-lg shadow-md w-full flex flex-col space-y-8">
        <h2 className="text-lg sm:text-xl font-semibold">Energy - Zone wise</h2>
...
<div ref={mountRef} className="w-full sm:min-h-[300px] aspect-[16/9] overflow-hidden relative" />
        )}

        <div className="flex space-x-12 pb-2 justify-center items-start">
          <div className="bg-[#008B8B] text-white px-2 py-2 sm:px-4 sm:py-3 rounded-lg shadow-lg border-2 border-[#99FF99] text-sm sm:text-lg font-bold">
            C-49
          </div>
          <div className="bg-[#FFA500] text-white px-2 py-2 sm:px-4 sm:py-3 rounded-lg shadow-lg border-2 border-[#FFFF99] text-sm sm:text-lg font-bold">
            C-50
          </div>
        </div>
      </div>
