...
const EnergyConsumption = () => {
  ...
  return (
    <div className="bg-white shadow rounded-lg p-4 sm:p-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-2">
        <h2 className="text-lg sm:text-xl font-semibold">Energy Heat Map</h2>
  ...
  className="pl-1 sm:pl-2 pr-1 sm:pr-2 sm:py-1 border border-gray-300 rounded-md text-xs sm:text-sm w-36"
/>
...
<input
  ...
  className="pl-1 sm:pl-2 pr-1 sm:pr-2 sm:py-1 border border-gray-300 rounded-md text-sm w-36"
/>
...
<button
  ...
  >
    <p className="hidden sm:block">Download Excel</p>
    <FiDownload className="block sm:hidden w-4 h-4" />
  </button>
      ...
      {loading ? <div className="text-center py-10">Loading...</div> :
       ...
       (
        <div className="sm:overflow-visible overflow-x-auto">
          <div className="sm:min-w-0 min-w-[1000px]">
